import { BadgePercent, Boxes, MessageCircle, PhoneCall, Truck } from "lucide-react";
import { Button } from "@/components/ui/button";
import { siteConfig } from "@/config/site";
import { getInitialEstimatorSelection } from "@/data/container-options";
import { createTelHref, createWhatsAppHref, selectionToContactSelection } from "@/lib/contact-links";
        ...
        <div className="relative z-10 max-w-3xl animate-fade-in-up lg:col-span-7">
          ...
          <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:items-center">
            {telHref ? (
              ...
              <Button type="button" size="lg" onClick={onCallback}>
                <PhoneCall aria-hidden />
                Vreau să fiu sunat
              </Button>
            )}
